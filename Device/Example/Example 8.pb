...
OpenWindow(0, 0, 0, 750, 450, "Example 8 - D3D9", #PB_Window_ScreenCentered | #PB_Window_SizeGadget | #PB_Window_MinimizeGadget | #PB_Window_MaximizeGadget)
...
Repeat
  If Device::FrameNext(*hDevice)
    ...
    Device::String(*hDevice, "GreenBytes", 0, -50, 70, 40, $FF000000 + Random($FFFFFF), "Arial", 10, Device::#STYLE_CENTER)
    Device::Rect(*hDevice, 0, 0, 200, 200, $FFFFFFFF, Device::#STYLE_CENTER)
    Device::RectFill(*hDevice, 0, 0, 20, 20, $FFFFFFFF, Device::#STYLE_CENTER)
    Device::Draw(*hDevice)
  EndIf
